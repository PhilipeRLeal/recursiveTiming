...
# This is a module that contains a find_version function which
# automatically # seeks, finds and returns the version of the package.

# The version of the package must be in the __init__.py file
# of the main directory;
# the version must be a string attributed to a variable named __version__.
